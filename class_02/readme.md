...
2. Introductions
3. Lecture: Variables and Movement
4. Break
5. Tutorial: Animation
6. Demos, Videos, Useful Links
...
![push](https://github.com/samheckle/code-toolkit-fa-25/blob/main/images/week_02/push.png?raw=true)
### Transformations
...
![translate](https://github.com/samheckle/critical-computation-lab-fa-26/raw/main/images/week2-translate.png)
